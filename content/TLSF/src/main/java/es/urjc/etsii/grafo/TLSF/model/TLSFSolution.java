...
public class TLSFSolution extends Solution<TLSFSolution, TLSFInstance> {
     ...
     * @param ins
     */
    public TLSFSolution(TLSFInstance ins) {
        super(ins);
     ...
     */
    public TLSFSolution(TLSFSolution s) {
        super(s);
        // TODO Copy ALL solution data, we are cloning a solution
        throw new UnsupportedOperationException("TLSFSolution() in TLSF not implemented yet");
    }


    @Override
    public TLSFSolution cloneSolution() {
        // You do not need to modify this method
        // Call clone constructor
        return new TLSFSolution(this);
    }

    @Override
    protected boolean _isBetterThan(TLSFSolution other) {
        // TODO given two solutions, is the current solution STRICTLY better than the other?
        throw new UnsupportedOperationException("isBetterThan() in TLSF not implemented yet");
    }
    ...
    public double getScore() {
        ...
        throw new UnsupportedOperationException("getScore() in TLSF not implemented yet");
    }
    ...
    public double recalculateScore() {
        ...
        throw new UnsupportedOperationException("recalculateScore() in TLSF not implemented yet");
    }
    ...
    public String toString() {
        ...
        throw new UnsupportedOperationException("toString() in TLSFSolution not implemented yet");
    }
}
